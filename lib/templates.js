...
exports.salesOrderDetail=function(soCode,lineNum,item,itemInfo){
	return {
		...
		//CostingMethod: '',SupplierCode: '', G = P / R = ( R - C ) / R
		...
		//CommodityCode: '',
		ParentItemCode: null,
		//ParentType: '',GroupCode: '',CustomerItemCode: '',
		...
		//DateCreated: '',
		UserModified: 'eSC',
		//DateModified: '',/MLID: '',ParentBundleItemCode: '',
		SortOrder: lineNum,
		CouponDiscount: 0.00,
		CouponDiscountRate: 0.00,
		SerializeLot: 'False',
		...
		//ProcessID: '',SourceCommissionCharge_DEV000221: '',SourceCommissionChargeRate_DEV000221: '',SourceFulfillmentCost_DEV000221: '',SourceFulfillmentCostRate_DEV000221: '',
		MaxDiscount: 0.00,
		IsSpecialOrder: 0
		//IsDiscountAmount: '',DiscountAmount: '',DiscountAmountRate: '',SpecialOrderItemDescription: '',IsAllocationModified: ''
	}
}
